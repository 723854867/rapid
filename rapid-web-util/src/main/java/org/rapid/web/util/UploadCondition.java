...
public class UploadCondition implements Condition {
	...
	public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
		try {
			...
			String value = properties.getProperty(CoreConsts.UPLOAD_ENABLE.getKey(), CoreConsts.UPLOAD_ENABLE.getDefaultValue());
